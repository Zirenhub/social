...
import { Award, Bell, Heart, MessageCircle, Users } from "lucide-react";
...
export default function Notifications() {
  ...
  const renderIcon = (type: string) => {
    switch (type) {
      ...
      case "comment":
        return <MessageCircle className="text-[var(--color-cyan-500)]" size={16} />;
      case "follow":
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-4 border border-gray-200 dark:border-gray-700 flex flex-col flex-grow min-h-0 w-full">
